...
import com.techscl.lovechat.BuildConfig;
import com.techscl.lovechat.R;
import com.techscl.lovechat.activity.RecorderVideoActivity;
import com.techscl.lovechat.customview.RecyclingImageView;
import com.techscl.lovechat.domain.VideoEntity;
import com.techscl.lovechat.util.ImageCache;
import com.techscl.lovechat.utils.ImageResizer;
import com.techscl.lovechat.utils.VideoUtils;
		...
		mGridView.setOnScrollListener(new AbsListView.OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView absListView,
				...
				if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_FLING) {
					// Before Honeycomb pause image loading on scro help
					// with performance
