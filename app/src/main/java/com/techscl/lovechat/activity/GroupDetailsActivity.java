...
import com.techscl.lovechat.ExitGroupDialog;
...
public class GroupDetailsActivity extends GestureActivity implements OnClickListener {
                                ...
                                try {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            ...
                                            To.showShort(getApplicationContext(), st6);
                                        }
                                    });
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            progressDialog.dismiss();
                                            To.showShort(getApplicationContext(), st7);
                                        }
                                    });
                                }
                            }
                            ...
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        refreshMembers();
                                        progressDialog.dismiss();
                                        To.showShort(getApplicationContext(), stsuccess);
                                    }
                                });
                            } catch (EaseMobException e) {
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        progressDialog.dismiss();
                                        To.showShort(getApplicationContext(), st9);
                                    }
                                });
                            }
                        }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            To.showShort(getApplicationContext(), getResources().getString(R.string.Exit_the_group_chat_failure));
                        }
                    });
                }
            }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            To.showShort(getApplicationContext(), st5 + e.getMessage());
                        }
                    });
                }
            }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            To.showShort(getApplicationContext(),st6+e.getMessage());
                        }
                    });
                }
            }
                    ...
                    public void onClick(View v) {
                        if (isInDeleteMode) {
                            ...
                            if (!NetUtils.hasNetwork(getApplicationContext())) {
                                To.showShort(getApplicationContext(),getString(R.string.network_unavailable));
                                return;
                            }
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            To.showShort(getApplicationContext(),st14+e.getMessage());
                                        }
                                    });
                                }
