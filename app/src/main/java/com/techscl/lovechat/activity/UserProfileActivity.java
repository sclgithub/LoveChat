...
public class UserProfileActivity extends GestureActivity implements OnClickListener {
	...
	public void asyncFetchUserInfo(String username){
		((LoveChatHXSDKHelper) HXSDKHelper.getInstance()).getUserProfileManager().asyncGetUserInfo(username, new EMValueCallBack<User>() {
	...
	private void updateRemoteNick(final String nickName) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				boolean updatenick = ((LoveChatHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().updateParseNickName(nickName);
	...
	private void uploadUserAvatar(final byte[] data) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				final String avatarUrl = ((LoveChatHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().uploadUserAvatar(data);
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						dialog.dismiss();
