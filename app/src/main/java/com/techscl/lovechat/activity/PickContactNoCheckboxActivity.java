...
import com.techscl.lovechat.customview.Sidebar;
...
public class PickContactNoCheckboxActivity extends GestureActivity {
...
//		}
	...
	private void getContactList() {
		contactList.clear();
		Map<String, User> users = ((LoveChatHXSDKHelper) HXSDKHelper.getInstance()).getContactList();
