...
import com.techscl.lovechat.db.sqlite.DemoDBManager;
import com.techscl.lovechat.db.sqlite.UserDao;
import com.techscl.lovechat.domain.RobotUser;
import com.techscl.lovechat.domain.User;
import com.techscl.lovechat.model.DefaultHXSDKModel;
 ...
 */
public class LoveChatHXSDKModel extends DefaultHXSDKModel {

    public LoveChatHXSDKModel(Context ctx) {
        super(ctx);
    }
