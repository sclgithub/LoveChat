...
import com.techscl.lovechat.model.HXNotifier;
import com.techscl.lovechat.model.HXSDKModel;
 ...
 *
 */
public class LoveChatHXSDKHelper extends HXSDKHelper {
    ...
    protected HXSDKModel createModel() {
        return new LoveChatHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((LoveChatHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((LoveChatHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public LoveChatHXSDKModel getModel(){
        return (LoveChatHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((LoveChatHXSDKModel) getModel()).getContactList();
        }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((LoveChatHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((LoveChatHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((LoveChatHXSDKModel)getModel()).saveContactList(mList);
    }
